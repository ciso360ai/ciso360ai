module.exports = {
	async up(knex) {
		...
		INSERT INTO directus_users (id, first_name, last_name, email, password, location, title, description, tags, avatar, language, theme, tfa_secret, status, role, token, last_access, last_page, provider, external_identifier, auth_data, email_notifications) VALUES ('ca4d7676-f94d-4561-a84f-4db18fba6d21', 'Demo', 'User', 'demo@ciso360.ai', '$argon2i$v=19$m=4096,t=3,p=REPLACE_ME', NULL, NULL, NULL, NULL, NULL, NULL, 'auto', NULL, 'active', 'fb9a9ff6-f729-481f-9c27-f152f30d4daa', NULL, NULL, NULL, 'default', NULL, NULL, true);
