module.exports = {
	async up(knex) {
		...
		INSERT INTO directus_users (id, first_name, last_name, password, status, role) VALUES ('ca4d7676-f94d-4561-a84f-4db18fba6d21', 'Demo', 'User', 'demo@ciso360.ai', 'draft', 'fb9a9ff6-f729-481f-9c27-f152f30d4daa');
