...
INSERT INTO directus_presets (bookmark, \"user\", role, collection, search, layout, layout_query, layout_options, refresh_interval, filter, icon, color) VALUES (NULL, NULL, NULL, 'actions', NULL, 'kanban', NULL, NULL, NULL, NULL, 'bookmark', NULL);
